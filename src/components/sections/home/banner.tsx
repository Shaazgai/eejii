      ...
      <div className="w-full">
        ...
        >
          <div className="flex w-full h-[434.64px] flex-col justify-between">
            <div className="flex h-[299.64px] flex-col items-start justify-center bg-[url('/images/homie/folderLeft.png')] bg-cover pl-3 text-start">
          ...
          <div className="h-[297.61px] bg-[url('/images/homie/folderLeftIMG.png')] bg-cover">
          ...
          <div className="h-[297.61px]  bg-[url('/images/homie/folderRightIMG.png')] bg-cover">
          ...
          <div className="flex h-[434.64px] flex-col justify-between">
            <div className="flex h-[299.64px]  flex-col items-start justify-center bg-[url('/images/homie/folderRight.png')] bg-cover pl-3 text-start">
              <img
              ...
              <Link href="#" className="relative top-2">
                <Button className="flex h-[58px]  justify-between rounded-3xl border-transparent bg-brand950 text-[12px] font-bold text-brand400 hover:bg-brand950">
                  Дэлгэрэнгүй
