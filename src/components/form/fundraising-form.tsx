...
import type { Contact, FundWithOwner } from '@/lib/types';
...
const FundraisingForm = ({
  ...
  const { mutate: deleteImage } = api.fundraising.deleteImage.useMutation({
    onSuccess: () => {
      context.fundraising.getById.invalidate({
